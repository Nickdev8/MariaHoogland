	...
	<div class="mx-auto grid max-w-7xl grid-cols-1 gap-x-16 px-6 py-24 lg:grid-cols-2">
		...
		>
			...
			<div class="mt-10">
				<button
					type="submit"
					class="block w-full rounded-md bg-sky-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
				>
					Bericht versturen
				</button>
			</div>
